...
<form class="form-inline" action="/HelloWeb/client/category/search" method="post">
...
<form action="/HelloWeb/client/category/search" method="post">
		<div class="topnav">
...
<div class="container">
	<table class="table table-dark table-striped">
		...
		<tr>
			...
			<td>${category.name }</td>			
			<td>
			<a href="/HelloWeb/client/category/detail?id=${category.id}">Show</a>
			</td>
		</tr>
</c:forEach>
