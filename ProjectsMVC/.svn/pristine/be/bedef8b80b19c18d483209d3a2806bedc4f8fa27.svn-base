...
<head>
    ...
    <!-- Fontfaces CSS-->
    <jsp:include page="/admin/view/css.jsp"></jsp:include>
...
<body class="animsition">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
        <jsp:include page="/admin/view/header.jsp"></jsp:include>
        <!-- END HEADER MOBILE-->
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="/ProjectsMVC/admin/images/icon/logo.png" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/ProjectsMVC/admin/images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/ProjectsMVC/admin/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/ProjectsMVC/admin/images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/ProjectsMVC/admin/images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="/ProjectsMVC/admin/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="/ProjectsMVC/admin/images/icon/avatar-01.jpg" alt="John Doe" />
                                        </div>
                                        <div class="content">
    ...
    <!-- Jquery JS-->
    <jsp:include page="/admin/view/js.jsp"></jsp:include>
