...
<form action="/HelloWeb/client/bills" method="post">
		<div class="topnav">
  <a class="active" href="/HelloWeb/client/views/index.jsp">Home</a>
  <a href="/HelloWeb/sp/search">Product</a>
	...
	<table>
		...
		<c:forEach items="${bills}" var="bill">
			<tr>
				...
				<td>${bill.date}</td>
				<td>
				<a href="/HelloWeb/member/bill-product?billid=${bill.id }">Information</a>
				<a href="/HelloWeb/member/bill/delete?billid=${bill.id }">Delete</a>
				</td>
...
<!-- 
           <td>
					<a href="/HelloWeb/client/product/detail?id=${pc.id}">Xem</a>
					<a href="/HelloWeb/client/product/detail?id=${pc.id}">Add to Bill</a>
				</td>
			</tr>
 -->
